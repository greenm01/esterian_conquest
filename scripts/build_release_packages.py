...
PACKAGE_SPECS = (
    PackageSpec(
        ...
        emulator_notes=(
            ...
            "DOSBox-X is currently the only verified local runner for this "
            "package."
        ),
        ...
        dosemu_status="Not currently working",
        dosemu_notes=(
            "Packed/oracle bundle; dosemu2 is not a working ECGAME path."
        ),
    ),
    PackageSpec(
        slug="unlocked",
        ...
        dosemu_status="Not currently working",
        dosemu_notes=(
            "dosemu2 remains blocked; current failures can occur before "
            "ECGAME startup."
        ),
    ),
)
...
def package_readme(spec: PackageSpec, package_root: Path) -> str:
    ...
    lines = [
        ...
        "DOSBox-X is currently the only verified local runner for the original "
        "EC v1.5 binaries.",
        "",
