...
pub fn visible_hazard_intel_is_empty(intel: &VisibleHazardIntel) -> bool {
...
pub fn rounded_coords_from_exact(exact: [f64; 2], target: [u8; 2]) -> [u8; 2] {
