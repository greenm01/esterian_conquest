...
fn results_reports_contact_before_destroyed_fleet_notice() {
    ...
    events.scout_contact_events.push(ScoutContactEvent {
        ...
        reporting_fleet_id: Some(15),
        coords,
        target_empire_raw: 3,
        target_fleet_id: Some(4),
        small_vessels: 2,
        medium_vessels: 2,
        large_vessels: 0,
...
fn results_reports_battle_before_bombard_aftermath() {
    ...
    events.scout_contact_events.push(ScoutContactEvent {
        ...
        reporting_fleet_id: Some(7),
        coords,
        target_empire_raw: 2,
        target_fleet_id: Some(9),
        small_vessels: 1,
        medium_vessels: 1,
        large_vessels: 0,
        stardate_week: Some(2),
