...
pub use nc_data::{
    ...
    DiplomaticRelation, EmpireEconomySummary, EmpireEliminationCause, EmpireEliminationEvent,
    ...
    MissionAbortReason, MissionEvent, MissionOutcome, MissionRetargetEvent, Order, PlanetBuildSpec,
    PlanetIntelEvent, PlanetIntelSource, PlanetOwnershipChangeEvent,
