...
fn print_usage() {
    println!("Usage:");
    println!("  nc-host seats list --dir <path>");
    println!("  nc-host seats reissue --dir <path> --player N");
    println!("  nc-host seats reset --dir <path> --player N");
    println!("  nc-host seats open --dir <path> --player N");
    println!("  nc-host seats close --dir <path> --player N");
}
