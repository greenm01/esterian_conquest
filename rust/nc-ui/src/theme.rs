...
const DEFAULT_THEME_KDL: &str = include_str!("../../nc-game/config/themes/tokyo_night.kdl");
const MATRIX_THEME_KDL: &str = include_str!("../../nc-game/config/themes/matrix.kdl");
const CATPPUCCIN_MOCHA_THEME_KDL: &str =
    include_str!("../../nc-game/config/themes/catppuccin_mocha.kdl");
const DRACULA_THEME_KDL: &str = include_str!("../../nc-game/config/themes/dracula.kdl");
const EVERFOREST_THEME_KDL: &str = include_str!("../../nc-game/config/themes/everforest.kdl");
const GRUVBOX_THEME_KDL: &str = include_str!("../../nc-game/config/themes/gruvbox.kdl");
const KANAGAWA_THEME_KDL: &str = include_str!("../../nc-game/config/themes/kanagawa.kdl");
const NORD_THEME_KDL: &str = include_str!("../../nc-game/config/themes/nord.kdl");
const ONE_DARK_THEME_KDL: &str = include_str!("../../nc-game/config/themes/one_dark.kdl");
const ROSE_PINE_THEME_KDL: &str = include_str!("../../nc-game/config/themes/rose_pine.kdl");
const SOLARIZED_THEME_KDL: &str = include_str!("../../nc-game/config/themes/solarized.kdl");
const MAG16_THEME_KDL: &str = include_str!("../../nc-game/config/themes/mag16.kdl");
...
impl Theme {
    fn from_kdl_str(source: &str) -> Result<Self, String> {
        ...
        Ok(Self {
            ...
            menu_featured_label: optional_style("menu_featured_label", "menu")?,
    ...
    fn monochrome_projection(&self) -> Self {
        ...
        theme.menu_featured_label = mono_bright(theme.menu_featured_label);
...
pub mod classic {
    ...
    pub fn menu_featured_label_style() -> CellStyle {
        active_theme().menu_featured_label
    }
