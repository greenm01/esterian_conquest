pub fn print_usage() {
    ...
    println!("  ec-cli invade-init [source_dir] <target_dir> <target_x> <target_y> <sc> <bb> <ca> <dd> <tt> <armies>");
    println!(
    ...
    println!("  ec-cli scenario <dir> <fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>");
    println!("  ec-cli scenario <dir> show <fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>");
    println!("  ec-cli scenario <dir> compose <fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>...");
    println!("  ec-cli scenario <dir> list");
    println!("  ec-cli scenario-init-all [source_dir] <target_root>");
    println!("  ec-cli scenario-init [source_dir] <target_dir> <fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>");
    println!("  ec-cli scenario-init-replayable [source_dir] <target_dir> <fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>");
    println!("  ec-cli scenario-init-compose [source_dir] <target_dir> <fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>...");
    println!("  ec-cli validate <dir> <all|fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>");
    println!("  ec-cli validate-preserved <dir> <all|fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>");
    println!("  ec-cli compare-preserved <dir> <all|fleet-order|planet-build|guard-starbase|ipbm|move|bombard|fleet-battle|invade|econ>");
