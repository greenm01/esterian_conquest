...
pub(crate) fn set_planet_name(
    ...
    println!("Planet record {} name set to '{}'", record_index_1_based, name);
    Ok(())
}
...
pub(crate) fn init_planet_original(
    dir: &Path,
) -> Result<(), Box<dyn std::error::Error>> {
    let mut data = CoreGameData::load(dir)?;
    ...
    // Homeworlds
    let hw_specs = [
        (5, [0x07, 0x04], 4, "Not Named Yet", [0x64, 0x87], 0x8648, 12),
        (8, [0x10, 0x05], 3, "Not Named Yet", [0x64, 0x87], 0x8648, 12),
        (13, [0x06, 0x0c], 2, "Not Named Yet", [0x64, 0x87], 0x8648, 12),
    ...
    // Unowned planets
    let unowned_specs = [
        (1, [0x06, 0x01], [0x93, 0x00]), (2, [0x10, 0x01], [0x24, 0x00]), (3, [0x0f, 0x03], [0x36, 0x00]), 
        (4, [0x05, 0x04], [0x3d, 0x00]), (6, [0x0f, 0x04], [0x1e, 0x00]), (7, [0x03, 0x05], [0x3e, 0x00]), 
        (9, [0x11, 0x09], [0x48, 0x00]), (10, [0x05, 0x0b], [0x46, 0x00]), (11, [0x06, 0x0b], [0x3f, 0x00]), 
        (12, [0x10, 0x0b], [0x66, 0x00]), (14, [0x0c, 0x0c], [0x23, 0x00]), (15, [0x0f, 0x0d], [0x41, 0x00]), 
        (17, [0x11, 0x0f], [0x2f, 0x00]), (18, [0x04, 0x10], [0x4f, 0x00]), (19, [0x10, 0x10], [0x35, 0x00]),
