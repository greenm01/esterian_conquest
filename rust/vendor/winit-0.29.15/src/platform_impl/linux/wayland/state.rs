...
impl WinitState {
    pub fn new(
        ...
        Ok(Self {
            ...
            // This workspace doesn't consume winit DeviceEvent mouse motion, and binding the
            // Wayland relative-pointer global has been provoking compositor/socket disconnects
            // during passive pointer dispatch in nc-dash.
