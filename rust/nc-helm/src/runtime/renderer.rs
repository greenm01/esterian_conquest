...
const GRID_ATLAS_MATRIX_COUNT: u32 = GRID_ATLAS_MATRIX_CHARS.len() as u32;
...
const GRID_ATLAS_BASE_GLYPH_COUNT: u32 =
    GRID_ATLAS_ASCII_COUNT + GRID_ATLAS_BOX_COUNT + GRID_ATLAS_MATRIX_COUNT + GRID_ATLAS_MISC_COUNT;
const GRID_ATLAS_COLS: u32 = 32;
const GRID_ATLAS_ROWS: u32 = 17;
...
const ATLAS_MATRIX_COUNT: u32 = 34u;
const ATLAS_MISC_COUNT: u32 = 6u;
const ATLAS_GLYPH_COUNT: u32 = ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + ATLAS_MATRIX_COUNT + ATLAS_MISC_COUNT;
const ATLAS_COLS: u32 = 32u;
const ATLAS_ROWS: u32 = 17u;
...
fn get_atlas_base_index(char_val: u32) -> i32 {
    ...
    switch char_val {
        case 0x03B1u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT); }
        case 0x03B2u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 1u); }
        case 0x03B3u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 2u); }
        case 0x03B4u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 3u); }
        case 0x03B5u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 4u); }
        case 0x03B6u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 5u); }
        case 0x03B7u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 6u); }
        case 0x03B8u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 7u); }
        case 0x03B9u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 8u); }
        case 0x03BAu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 9u); }
        case 0x03BBu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 10u); }
        case 0x03BCu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 11u); }
        case 0x03BDu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 12u); }
        case 0x03BEu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 13u); }
        case 0x03BFu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 14u); }
        case 0x03C0u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 15u); }
        case 0x03C1u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 16u); }
        case 0x03C3u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 17u); }
        case 0x03C2u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 18u); }
        case 0x03C4u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 19u); }
        case 0x03C5u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 20u); }
        case 0x03C6u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 21u); }
        case 0x03C7u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 22u); }
        case 0x03C8u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 23u); }
        case 0x03C9u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 24u); }
        case 0x03F2u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 25u); }
        case 0x03DBu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 26u); }
        case 0x03DFu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 27u); }
        case 0x03E1u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 28u); }
        case 0x00B4u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 29u); }
        case 0x1FC0u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 30u); }
        case 0x1FBFu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 31u); }
        case 0x1FFEu: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 32u); }
        case 0x0345u: { return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + 33u); }
        case 0x25B3u: {
            return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + ATLAS_MATRIX_COUNT);
        }
        case 0x2A01u: {
            return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + ATLAS_MATRIX_COUNT + 1u);
        }
        case 0x00B7u: {
            return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + ATLAS_MATRIX_COUNT + 2u);
        }
        case 0x25CAu: {
            return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + ATLAS_MATRIX_COUNT + 3u);
        }
        case 0x2014u: {
            return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + ATLAS_MATRIX_COUNT + 4u);
        }
        case 0x25CFu: {
            return i32(ATLAS_ASCII_COUNT + ATLAS_BOX_COUNT + ATLAS_MATRIX_COUNT + 5u);
        }
        default: {}
    }
    return -1;
...
fn fs_main(in: VertexOut) -> @location(0) vec4<f32> {
    ...
    if (selection_corner < 0) {
        ...
        if (atlas_idx >= 0) {
            ...
            let atlas_height_px = f32(ATLAS_ROWS * grid_config.cell_height_px);
...
impl Renderer {
    ...
    fn render_matrix_locked(&mut self) -> Result<RenderTimings, Box<dyn std::error::Error>> {
        let total_start = Instant::now();
        self.sync_scale_metrics();
        let size = self.window.inner_size();
        if size.width == 0 || size.height == 0 {
...
fn char_atlas_base_index(ch: char) -> Option<u32> {
    ...
    if let Some(index) = GRID_ATLAS_MATRIX_CHARS
        .iter()
...
fn atlas_repertoire_chars() -> Vec<char> {
    ...
    chars.extend(GRID_ATLAS_MATRIX_CHARS);
