...
impl Screen for StarbaseMenuScreen {
    ...
    fn handle_key(&self, key: KeyEvent) -> Action {
        match key.code {
            KeyCode::Char('h') | KeyCode::Char('H') => Action::OpenStarbaseHelp,
            KeyCode::Char('q') | KeyCode::Char('Q') | KeyCode::Esc => Action::OpenFleetMenu,
            KeyCode::Char('x') | KeyCode::Char('X') => Action::ShowStarbaseExpertModeNotice,
            KeyCode::Char('s') | KeyCode::Char('S') => Action::OpenStarbaseList,
            KeyCode::Char('r') | KeyCode::Char('R') => Action::OpenStarbaseReviewSelect,
            KeyCode::Char('m') | KeyCode::Char('M') => Action::ShowStarbaseMoveNotice,
            KeyCode::Char('v') | KeyCode::Char('V') => {
                Action::OpenPartialStarmapPrompt(crate::screen::CommandMenu::Starbase)
            }
            KeyCode::Char('i') | KeyCode::Char('I') => {
                Action::OpenPlanetInfoPrompt(crate::screen::CommandMenu::Starbase)
            }
            _ => Action::Noop,
        }
    }
...
impl StarbaseListScreen {
    ...
    pub fn handle_key(&self, key: KeyEvent) -> Action {
        match key.code {
            ...
            KeyCode::Char('q') | KeyCode::Char('Q') | KeyCode::Esc => Action::OpenStarbaseMenu,
            _ => Action::Noop,
        }
    }
}
