...
pub fn update(app: &mut App, action: PlanetAction) {
    match action {
        ...
        PlanetAction::SubmitListSortPrompt(mode) => app.submit_planet_list_sort_prompt(mode),
        ...
        PlanetAction::SubmitDatabaseSortPrompt => app.submit_planet_database_sort_prompt(),
