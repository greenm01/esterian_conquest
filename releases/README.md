...
## ec-connect Player Archives

The player-facing Rust public download is `ec-connect`.

| Bundle | Platform | Contents |
|---|---|---|
| `ec-connect-v1.0.0-beta.1-windows-x64.zip` | Windows x64 (`x86_64-pc-windows-msvc`) | `ec-connect.exe`, player manual PDF, `README.md`, `BUILD-INFO.txt`, and font license files |
| `ec-connect-v1.0.0-beta.1-linux-x64.tar.gz` | Linux x64 (`x86_64-unknown-linux-gnu`) | `ec-connect`, player manual PDF, `README.md`, and `BUILD-INFO.txt` |
| `ec-connect-v1.0.0-beta.1-macos-arm64.tar.gz` | macOS Apple Silicon (`aarch64-apple-darwin`) | `ec-connect`, player manual PDF, `README.md`, and `BUILD-INFO.txt` |
...
`ec-connect.exe`; `ec-connect-cli` is Cargo/source-only and is not bundled in
