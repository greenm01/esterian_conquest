...
Use `fixtures/ecmaint-post/v1.5/` only if the scenario requires a post-maint-derived file to exist first, and record that exception explicitly in `docs/dev/archive/RE_NOTES.md`.
...
The fixture note in `docs/dev/archive/RE_NOTES.md` must include:
...
3. a diff summary recorded in `docs/dev/archive/RE_NOTES.md`
