...
public class ReportIPBMTailTransition extends GhidraScript {

    private static final String OUTPUT_PATH = "artifacts/ghidra/ecmaint-live/ipbm-tail-transition.txt";
    ...
    protected void run() throws Exception {
        ...
        Address start = toAddr("0000:0de9");
        Address end = toAddr("0000:0ec8");
        ...
        try (PrintWriter out = new PrintWriter(new FileWriter(outFile))) {
            ...
            while (inst != null && inst.getAddress().compareTo(end) <= 0 && !monitor.isCancelled()) {
                ...
                for (int i = 0; i < inst.getNumOperands(); i++) {
                    for (Object object : inst.getOpObjects(i)) {
        ...
        println("ReportIPBMTailTransition> wrote " + outFile.getCanonicalPath());
    }
