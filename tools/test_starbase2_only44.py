...
target = "/tmp/test-starbase2-only44"
...
# ONLY change 0x44 to 2. Leave 0x46 as 1 (or 0).
# In ecmaint-starbase-pre, 0x44 is 1, 0x46 is 0. Wait, let's check!
# Actually, I'll explicitly set 0x44 to 2, and 0x46 to 1.
patch_file(os.path.join(target, 'PLAYER.DAT'), 0x44, [0x02, 0x00, 0x01, 0x00])
...
# base_record_2: ID=2, local slot=2
