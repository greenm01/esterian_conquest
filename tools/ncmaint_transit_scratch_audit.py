...
def render_markdown(results: list[ProbeResult]) -> str:
    ...
    lines.extend(
        [
            ...
            "",
            "The current Rust exact-position encoding in `nc-data::fleet_motion_state` should be treated as an internal movement/ETA seam rather than as a classic-compatibility claim. The controlled oracle evidence here supports:",
            "",
